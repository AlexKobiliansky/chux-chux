$(document).ready(function(){
    ...
    $('.dark-theme-switcher').click(function(){
        $('body').removeClass('light-theme').addClass('dark-theme');
        $('.dark-theme-switcher').addClass('active');
        $('.light-theme-switcher').removeClass('active');
    });

    $('.light-theme-switcher').click(function(){
        $('body').removeClass('dark-theme').addClass('light-theme');
        $('.light-theme-switcher').addClass('active');
        $('.dark-theme-switcher').removeClass('active');
    });
